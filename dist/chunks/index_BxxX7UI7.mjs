const id = "index.mdx";
					...
					},actions:[{text:"ghqc User Guide",link:"guides/2_summary",variant:"primary",icon:{type:"icon",name:"right-arrow"}},{text:"Explore the ghqc repository",link:"https://github.com/a2-ai/ghqc",variant:"minimal",icon:{type:"icon",name:"external"}}]},sidebar:{hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
