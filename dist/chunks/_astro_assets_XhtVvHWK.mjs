import { b as createAstro, c as createComponent, f as defineStyleVars, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, e as addAttribute, u as unescapeHTML, a as renderComponent, d as renderSlot, F as Fragment } from './astro/server_C6X8rgM3.mjs';
import 'kleur/colors';
import { f as AstroUserError, A as AstroError, g as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, E as ExpectedImageOptions, h as ExpectedImage, i as ExpectedNotESMImage, r as resolveSrc, j as isRemoteImage, k as isESMImportedImage, l as isLocalService, D as DEFAULT_HASH_PROPS, m as InvalidImageService, n as ImageMissingAlt } from './astro/assets-service_DqEecZtb.mjs';
import { s as starlightConfig, B as BuiltInDefaultLocale, u as useTranslations } from './translations_D9B64J3o.mjs';
...
async function createRenderer() {
  const { astroConfig, ecConfigFileOptions, ecIntegrationOptions = {} } = await import('./config_BL-mLtO9.mjs');
  ...
  try {
    const { default: preprocessEcConfig } = await import('./preprocess-config_Dp7VGjpm.mjs');
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_DqEecZtb.mjs'
    ).then(n => n.s).catch((e) => {
