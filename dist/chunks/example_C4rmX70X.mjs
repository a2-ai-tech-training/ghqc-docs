import { c as createComponent, r as renderTemplate, m as maybeRenderHead, u as unescapeHTML } from './astro/server_C6X8rgM3.mjs';
import 'kleur/colors';
import 'clsx';
...
const html = "<p>Reference pages are ideal for outlining how things work in terse and clear terms.\nLess concerned with telling a story or addressing a specific use case, they should give a comprehensive outline of what you’re documenting.</p>\n<h2 id=\"further-reading\">Further reading</h2>\n<ul>\n<li>Read <a href=\"https://diataxis.fr/reference/\">about reference</a> in the Diátaxis framework</li>\n</ul>";
				...
				const file = "/Users/jennaelwing/starlight/ghqc/ghqc-docs/src/content/docs/reference/example.md";
				const url = undefined;
				function rawContent() {
