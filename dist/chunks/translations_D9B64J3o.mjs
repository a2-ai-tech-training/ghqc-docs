...
import { V as VALID_INPUT_FORMATS, A as AstroError, U as UnknownContentCollectionError, f as AstroUserError } from './astro/assets-service_DqEecZtb.mjs';
import { c as createComponent, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, r as renderTemplate, a as renderComponent, u as unescapeHTML } from './astro/server_C6X8rgM3.mjs';
import 'kleur/colors';
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/ghqc-docs/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://a2-ai-tech-training.github.io", "SSR": true};
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/guides/1_install.mdx": () => import('./1_install_C9YdsuE3.mjs'),"/src/content/docs/guides/2_summary.mdx": () => import('./2_summary_ClpAMRVf.mjs'),"/src/content/docs/guides/code-annotation.mdx": () => import('./code-annotation_DBrDfPXp.mjs'),"/src/content/docs/guides/component-showcase.mdx": () => import('./component-showcase_CyH85EJy.mjs'),"/src/content/docs/index.mdx": () => import('./index_wkA0IZs3.mjs'),"/src/content/docs/reference/example.md": () => import('./example_aayehR-I.mjs')});
...
let lookupMap = {};
lookupMap = {"docs":{"type":"content","entries":{"guides/1_install":"/src/content/docs/guides/1_install.mdx","index":"/src/content/docs/index.mdx","guides/2_summary":"/src/content/docs/guides/2_summary.mdx","guides/code-annotation":"/src/content/docs/guides/code-annotation.mdx","guides/component-showcase":"/src/content/docs/guides/component-showcase.mdx","reference/example":"/src/content/docs/reference/example.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/guides/1_install.mdx": () => import('./1_install_BMAusyr8.mjs'),"/src/content/docs/guides/2_summary.mdx": () => import('./2_summary_Cqd_lCnb.mjs'),"/src/content/docs/guides/code-annotation.mdx": () => import('./code-annotation_B4Jmwujy.mjs'),"/src/content/docs/guides/component-showcase.mdx": () => import('./component-showcase_C9J3QHiv.mjs'),"/src/content/docs/index.mdx": () => import('./index_Bf2GWDaE.mjs'),"/src/content/docs/reference/example.md": () => import('./example_k2tqCW3c.mjs')});
