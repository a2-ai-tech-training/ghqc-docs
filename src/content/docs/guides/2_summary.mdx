...
import workflow_summary_dark from '/ghqc-docs/src/assets/summary_workflow/workflow_summary_dark.png';
import assign_diagram from '/ghqc-docs/src/assets/summary_workflow/assign_diagram.png';
import milestone_example from '/ghqc-docs/src/assets/summary_workflow/milestone_example.png';
import issue_example from '/ghqc-docs/src/assets/summary_workflow/issue_example.png';
import assign_example from '/ghqc-docs/src/assets/summary_workflow/assign_example.mp4';
import qc_feedback1 from '/ghqc-docs/src/assets/summary_workflow/qc_feedback1.png';
import qc_feedback2 from '/ghqc-docs/src/assets/summary_workflow/qc_feedback2.png';
import qc_feedback3 from '/ghqc-docs/src/assets/summary_workflow/qc_feedback3.png';
import qc_feedback4 from '/ghqc-docs/src/assets/summary_workflow/qc_feedback4.mp4';
import qc_feedback5 from '/ghqc-docs/src/assets/summary_workflow/qc_feedback5.png';
import resolve1mp4 from '/ghqc-docs/src/assets/summary_workflow/resolve1.mp4';
import resolve1png from '/ghqc-docs/src/assets/summary_workflow/resolve1.png';
import issue_closed from '/ghqc-docs/src/assets/summary_workflow/issue_closed.mp4';
import milestone_closed from '/ghqc-docs/src/assets/summary_workflow/milestone_closed.mp4';
import record1 from '/ghqc-docs/src/assets/summary_workflow/record1.mp4';
import record1_png from '/ghqc-docs/src/assets/summary_workflow/record1.png';
import record2_png from '/ghqc-docs/src/assets/summary_workflow/record2.png';
import record3_png from '/ghqc-docs/src/assets/summary_workflow/record3.png';
...
<Image src={/ghqc-docs/workflow_summary_light} className="light:sl-hidden" alt="summary workflow light"/>
