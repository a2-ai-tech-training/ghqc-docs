---
title: ghqc Ecosystem Installation and Setup
...
<Card title="ghqc.app" icon="add-document">
    ...
    To ensure the dependencies do not interfere with any project work, ghqc.app and its dependencies is installed into an isolated directory outside of the QCed project.
</Card>
<Card title="Custom configuration repository " icon="information">
    Custom options for app inputs and outputs are configured by an organization administrator in a custom configuration repository.\
    This repository includes the selectable checklists for QCed files.
    
    Learn more at <a href="/ghqc-docs/reference/custom_config">the Custom Configuration page</a>
</Card>
