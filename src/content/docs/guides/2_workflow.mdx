...
The Author always catalyzes QC with the **inital qc commit**. This "starting line" for the QCer is automaticatally generated in the metadata of the Issue body when it's 
...
Posting the commits between the initial and approved QC commits is not manditory, but doing so helps to illustrate a timeline. 

- The QCer doesn't have to commit in-line code comments - comments can be conveyed in other ways
- Likewise, the Author doesn't have to post QC notifiications - script updates can be conveyed in other ways
...
<Aside type="tip" title="The benefits of posting QC commits">
  ...
  - Protection from yourself 
      ...
      - The "QC Approved" comment includes a summary between the inital and approved QC commits to "sanity check" final QC file states
</Aside>
