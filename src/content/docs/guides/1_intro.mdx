...
<Aside type='tip' title="ghqc: a new way to perform QC">

ghqc is an R package that facilitates a 
<u>G</u>it<u>H</u>ub-centric 
<u>Q</u>uality <u>C</u>ontrol workflow via Shiny apps for improved configuration, workflow, and traceability.

##### Configuration

ghqc leverages Git's version control to help collaborators stay synchronized with the evolution of a QC.

##### Workflow

ghqc streamlines QC initialization, discussion, updates, and approval through structured automation.

##### Traceability

ghqc generates a static, auditable record of QC history for long-term archival.
...
_ghqc co-opts GitHub Issues and Milestones as the nexus for QC processes._
