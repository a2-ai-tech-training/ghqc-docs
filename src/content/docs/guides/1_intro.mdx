...
The QCer is notified of QC assignment in GitHub or recieves the Issue link and assigns herself.

To review, the QCer:
- Clones the repo/pulls the inital qc commit given by the metadata section
- Reviews the file 
