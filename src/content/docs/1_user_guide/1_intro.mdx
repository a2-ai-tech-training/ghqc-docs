...
ghqc is an R package that facilitates 
<u>G</u>it<u>H</u>ub-centric 
<u>Q</u>uality <u>C</u>ontrol via R Shiny apps for improved collaboration, workflow, and traceability.

##### Collaboration

ghqc leverages Git's version control to help authors and QCers stay synchronized with the evolution of a QC.
